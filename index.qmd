...
a(
  ...
  p(
    ...
    HTML("<b>Join us March 27-29 for Philly's 3rd Social Justice Hackathon!</b>")
  )
)
```
:::
...
h4(
    class="text-left",
    HTML("A Tech for Change Hackathon")
)
h3(
    class="text-left",
    HTML("March 27th-29th @ Penn Carey Law School")
)
```
:::
...
add_info_card(
  ...
  body = 
    ...
    Help us create impactful projects, by submitting a project idea.", 
  button_text = "Submit Project Idea", 
  button_link = "https://docs.google.com/forms/d/e/1FAIpQLSfUVtuWdj3NytRAThzxfP9og4ZH9EJjzq1DSzb58CEmqItCcQ/viewform"
)
...
add_info_card(
  ...
  button_link = "https://docs.google.com/forms/d/e/1FAIpQLScazbhnRvFCYoIeX2Xi2_I0oyvTrxsCkO2xgBezbg8UArwK-g/viewform"
)
```
:::
::::::
